 ...
 */
public abstract class SBP_GenerateMovementFromStorageAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_GenerateMovementFromStorage";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "SBP_GenerateMovementFromStorage";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54495;
